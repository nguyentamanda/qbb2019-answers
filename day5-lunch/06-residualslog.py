...
"""
Usage: ./06-residualslog.py ../results/stringtie/SRR072893/t_data.ctab H3K4me1.tab H3K4me3.tab H3K9me3.tab
"""
...
model = sm.formula.ols(formula = "logFPKM ~ H1 + H2 + H3", data=histone_df)
